...
// // Arrays are structured with a specific order of indexes

// console.log(monster.types);
// console.log(monster.types[1]);

// Objects are accessed by their definition name (key)
...
for(var i = 0; i < pokémon.length; i++)
{
    // Loop through object, return pokemon with conditions
    if(pokémon[i].types.length < 2 && pokémon[i].types[0] == "poison")
    {
